...
var testdata = []struct {
	...
	subscription S($v:Input!){
		...
		{198, gqlscan.TokenOprName, "Todos"},
		...
		// Subscription S
		{218, gqlscan.TokenDefSub, ""},
		{219, gqlscan.TokenOprName, "S"},
		{220, gqlscan.TokenVarList, ""},
		{221, gqlscan.TokenVarName, "v"},
		{222, gqlscan.TokenVarTypeName, "Input"},
		{223, gqlscan.TokenVarTypeNotNull, ""},
		{224, gqlscan.TokenVarListEnd, ""},
		{225, gqlscan.TokenSel, ""},
		{226, gqlscan.TokenField, "sub"},
		{227, gqlscan.TokenArgList, ""},
		{228, gqlscan.TokenArg, "i"},
		{229, gqlscan.TokenVarRef, "v"},
		{230, gqlscan.TokenArgListEnd, ""},
		{231, gqlscan.TokenSel, ""},
		{232, gqlscan.TokenField, "f"},
		{233, gqlscan.TokenSelEnd, ""},
		{234, gqlscan.TokenSelEnd, ""},
	}},
	...
	{62, `subscription S{f}`, []Expect{
		{0, gqlscan.TokenDefSub, ""},
		{1, gqlscan.TokenOprName, "S"},
		{2, gqlscan.TokenSel, ""},
		{3, gqlscan.TokenField, "f"},
		{4, gqlscan.TokenSelEnd, ""},
	}},
}
...
func TestLevel(t *testing.T) {
	...
	expect := []struct {
		...
		{198, gqlscan.TokenOprName, "Todos", 0},
