...
var testdata = []struct {
	...
	{Decl(), `{f(f: -42.5678e2)}`, []Expect{
		...
		{Decl(), gqlscan.TokenArgList, ""},
		{Decl(), gqlscan.TokenArg, "f"},
		{Decl(), gqlscan.TokenNum, "-42.5678e2"},
		{Decl(), gqlscan.TokenArgListEnd, ""},
		{Decl(), gqlscan.TokenSelEnd, ""},
	}},
	{Decl(), `{ f (f: {x: 2}) }`, []Expect{
	...
	subscription S($v:Input!){
		...
		{Decl(), gqlscan.TokenNum, "123456789.1234e2"},
	...
	{Decl(), `{f(a:
		...
		{Decl(), gqlscan.TokenNum, "123456789"},
		{Decl(), gqlscan.TokenArgListEnd, ""},
		{Decl(), gqlscan.TokenSelEnd, ""},
	}},
...
func TestLevel(t *testing.T) {
	...
	expect := []struct {
		...
		{Decl(), gqlscan.TokenNum, "0", 3},
		{Decl(), gqlscan.TokenObjField, "number1", 3},
		{Decl(), gqlscan.TokenNum, "2", 3},
		{Decl(), gqlscan.TokenObjField, "number2", 3},
		{Decl(), gqlscan.TokenNum, "123456789.1234e2", 3},
